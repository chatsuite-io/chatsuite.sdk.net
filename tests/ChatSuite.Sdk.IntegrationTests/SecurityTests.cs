...
public class SecurityTests(ITestOutputHelper testOutputHelper, ReliableConnectionFixture fixture) : TestBed<ReliableConnectionFixture>(testOutputHelper, fixture)
{
	...
	{
		var settings = _fixture.GetService<IOptions<EntraIdTokenAcquisitionSettings>>(_testOutputHelper)!;
		var plugin = _fixture.GetService<IPlugin<EntraIdTokenAcquisitionSettings, string?>>(_testOutputHelper)!;
